...
Route::get('/bky-jute-mills', [front::class,'bkyjute'])->name('bkyjute');
Route::get('/president-speech', [front::class,'presidentsp'])->name('presidentsp');
Route::get('/management', [front::class,'management'])->name('management');
Route::get('/mision-vision', [front::class,'mision_vision'])->name('mision-vision');
